...
public type ListenerConfig record {
    @display {label: "API Secret", "description": "Secret specified for Twitter app created"}
    string apiSecret = DEFAULT_SECRET;
};
...
public type TweetDeleteEvent record {
    string for_user_id;
...
# Information about favorite event
#
# + for_user_id - User ID  
# + favorite_events - Description about event when someone make tweet favorited
public type FavoriteEvent record {
    string for_user_id;
    FavoriteEventInfo[] favorite_events;
};

# Defines a favorite event
#
# + id - ID of favorited tweet   
# + created_at - Event creation time  
# + timestamp_ms - Favorited event timestamp 
# + favorited_status - Tweet object assiciated with event 
# + user - User object who favorited tweet  
public type FavoriteEventInfo record {
    string id;
    string? created_at?;
    int? timestamp_ms?;
...
public type GenericDataType TweetEvent|TweetDeleteEvent|FollowEvent|FavoriteEvent;
